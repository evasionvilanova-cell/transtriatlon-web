  ...
  .ev-grid{grid-template-columns:1fr}
      ...
      <footer className="ftr" id="contact">
        <div className="ftr-grid">
          <div>
            ...
            <div className="ftr-social">
              <a href="https://www.facebook.com/entrenosdetriatlon.nicosaenz" target="_blank" rel="noreferrer">f</a>
              <a href="https://www.instagram.com/transtriatlon/" target="_blank" rel="noreferrer">ig</a>
              <a href="https://www.strava.com/athletes/8167392" target="_blank" rel="noreferrer">S</a>
            </div>
          </div>
          <div>
            <h5>Programas</h5>
        ...
        <div className="ftr-bottom">
          ...
          <Link to="/dashboard" style={{ color: "rgba(255,255,255,.15)", fontSize: 11, textDecoration: "none" }}>Dashboard</Link>
