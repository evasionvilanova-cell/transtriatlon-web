...
export default function Dashboard() {
  ...
  const [newEvent, setNewEvent] = useState({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "", imagenesUrl: "" });
  ...
  const saveEvent = async () => {
    ...
    try {
      ...
      setNewEvent({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "", imagenesUrl: "" });
      loadEvents();
    } catch (e) { setMsg("Error: " + e.message); }
  };
  ...
  const startEditEvent = (ev) => {
    setEditingEvent(ev);
    setNewEvent({ title: ev.title || "", date: ev.date || "", type: ev.type || "Triatlón", imgUrl: ev.imgUrl || "", description: ev.description || "", reglamentoUrl: ev.reglamentoUrl || "", inscripcionUrl: ev.inscripcionUrl || "", resultadosUrl: ev.resultadosUrl || "", imagenesUrl: ev.imagenesUrl || "" });
    setMsg("Editando: " + ev.title); window.scrollTo({ top: 0, behavior: "smooth" });
  };

  const cancelEdit = () => { setEditingEvent(null); setNewEvent({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "", imagenesUrl: "" }); setMsg(""); };
        ...
        <div className="d-main">
          ...
          {tab === "events" && (<>
            ...
            <div className="d-card" style={{ borderColor: editingEvent ? "var(--red)" : undefined }}>
              ...
              <div className="d-field"><label>Tipo</label><select value={newEvent.type} onChange={(e) => setNewEvent({ ...newEvent, type: e.target.value })}><option>Triatlón</option><option>Duatlón</option><option>Acuatlón</option><option>Natación</option><option>Aquabike</option><option>Swimrun</option></select></div>
              <div className="d-field">
