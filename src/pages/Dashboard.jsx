...
export default function Dashboard() {
  ...
  const startEditEvent = (ev) => {
    setEditingEvent(ev);
    setNewEvent({ title: ev.title || "", date: ev.date || "", type: ev.type || "Triatlón", imgUrl: ev.imgUrl || "", description: ev.description || "", reglamentoUrl: ev.reglamentoUrl || "", inscripcionUrl: ev.inscripcionUrl || "", resultadosUrl: ev.resultadosUrl || "" });
    setMsg("Editando: " + ev.title); window.scrollTo({ top: 0, behavior: "smooth" });
  };

  const cancelEdit = () => { setEditingEvent(null); setNewEvent({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "" }); setMsg(""); };
