...
export default function Dashboard() {
  ...
  const [newEvent, setNewEvent] = useState({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "", resultadosNombre: "", resultadosUrl2: "", resultadosNombre2: "", imagenesUrl: "", popup: false, popupResultados: false });
  ...
  const saveEvent = async () => {
    ...
    try {
      ...
      setNewEvent({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "", resultadosNombre: "", resultadosUrl2: "", resultadosNombre2: "", imagenesUrl: "", popup: false, popupResultados: false });
      loadEvents();
    } catch (e) { setMsg("Error: " + e.message); }
  };
  ...
  const startEditEvent = (ev) => {
    setEditingEvent(ev);
    setNewEvent({ title: ev.title || "", date: ev.date || "", type: ev.type || "Triatlón", imgUrl: ev.imgUrl || "", description: ev.description || "", reglamentoUrl: ev.reglamentoUrl || "", inscripcionUrl: ev.inscripcionUrl || "", resultadosUrl: ev.resultadosUrl || "", resultadosNombre: ev.resultadosNombre || "", resultadosUrl2: ev.resultadosUrl2 || "", resultadosNombre2: ev.resultadosNombre2 || "", imagenesUrl: ev.imagenesUrl || "", popup: ev.popup || false, popupResultados: ev.popupResultados || false });
    setMsg("Editando: " + ev.title); window.scrollTo({ top: 0, behavior: "smooth" });
  };

  const cancelEdit = () => { setEditingEvent(null); setNewEvent({ title: "", date: "", type: "Triatlón", imgUrl: "", description: "", reglamentoUrl: "", inscripcionUrl: "", resultadosUrl: "", resultadosNombre: "", resultadosUrl2: "", resultadosNombre2: "", imagenesUrl: "", popup: false, popupResultados: false }); setMsg(""); };
        ...
        <div className="d-main">
          ...
          {tab === "events" && (<>
            ...
            <div className="d-card" style={{ borderColor: editingEvent ? "var(--red)" : undefined }}>
              ...
              {newEvent.resultadosUrl && <div className="d-field" style={{ flexDirection: "row", alignItems: "center", gap: 10 }}><input type="checkbox" id="popupResChk" checked={newEvent.popupResultados} onChange={(e) => setNewEvent({ ...newEvent, popupResultados: e.target.checked })} style={{ width: 18, height: 18, accentColor: "#0a8a0a", flex: "0 0 auto" }} /><label htmlFor="popupResChk" style={{ margin: 0, cursor: "pointer" }}>📊 Mostrar pop-up de resultados al abrir la web</label></div>}
