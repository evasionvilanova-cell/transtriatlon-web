        ...
        <div className="d-main">
          ...
          {tab === "events" && (<>
            ...
            <div className="d-card" style={{ borderColor: editingEvent ? "var(--red)" : undefined }}>
              ...
              <div className="d-field"><label>Tipo</label><select value={newEvent.type} onChange={(e) => setNewEvent({ ...newEvent, type: e.target.value })}><option>Running<option>Triatlón</option><option>Duatlón</option><option>Acuatlón</option><option>Natación</option><option>Aquabike</option><option>Swimrun</option></select></div>
              <div className="d-field">
